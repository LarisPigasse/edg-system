...
/**
 * IDENTITÀ E CONFIGURAZIONE DELL'APPLICAZIONE
 *
...
export const EDG_CONFIG: EdgConfig = {
  app: {
    ...
    // Unico elemento grafico che distingue questo frontend dal gestionale
    icon: 'icon',
  },
  routes: {
    home: ROUTES.HOME,
  ...
  layout: {
    ...
    innerPageBgOpacity: 'opacity-[0.64]',
