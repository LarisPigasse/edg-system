  ...
  return (
    ...
    >
      <div className={cn("flex items-center", config.gap)}>
        <div className={cn(config.dot, "bg-action-primary rounded-full animate-spinner-pulse")} />
        <div className={cn(config.dot, "bg-action-primary rounded-full animate-spinner-pulse [animation-delay:0.16s]")} />
        <div className={cn(config.dot, "bg-action-primary rounded-full animate-spinner-pulse [animation-delay:0.32s]")} />
      </div>
    </div>
  );
};
