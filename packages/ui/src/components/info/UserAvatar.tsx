...
const UserAvatar: React.FC<UserAvatarProps> = ({ initials, size = "md", onClick, className = "", variant = "primary" }) => {
  ...
  const variantClasses = {
    ...
    secondary: "bg-action-info text-white",
  ...
  const interactionClasses = onClick
    ? "cursor-pointer hover:scale-105 hover:shadow-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-action-primary focus:ring-offset-2"
    : "";
