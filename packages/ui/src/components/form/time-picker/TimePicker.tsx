                    ...
                    {hourOptions.map(hour => (
                      <button
                        ...
                        className={cn(
                          ...
                          selectedHour === hour && 'bg-action-primary text-white hover:bg-action-primary-hover',
                          'focus:outline-none focus:ring-1 focus:ring-action-primary'
                        )}
                        disabled={disabled}
                      >
                  ...
                  <div className='max-h-32 overflow-y-auto border border-border-default rounded'>
                    {minuteOptions.map(minute => (
                      <button
                        ...
                        className={cn(
                          'w-full px-3 py-1.5 text-center transition-colors hover:bg-bg-hover',
                          selectedMinute === minute && 'bg-action-primary text-white hover:bg-action-primary-hover',
                          'focus:outline-none focus:ring-1 focus:ring-action-primary'
                        )}
                        disabled={disabled}
                      >
                      ...
                      {(['AM', 'PM'] as const).map(period => (
                        <button
                          ...
                          className={cn(
                            ...
                            amPm === period && 'bg-action-primary text-white hover:bg-action-primary-hover',
                            'focus:outline-none focus:ring-1 focus:ring-action-primary'
                          )}
                          disabled={disabled}
                        >
              ...
              <div className='flex justify-center mt-4 pt-3 border-t border-border-default'>
                <button
                  ...
                  className={cn(
                    ...
                    'text-text-link hover:bg-surface-3',
