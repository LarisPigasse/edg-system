...
// Lo slice non conosce lo store dell'applicazione: i selector richiedono solo
// che `authReducer` sia montato sotto la chiave `auth`, come fa uiSlice in @edg/ui.
...
export const selectAccount = (state: AuthRootState) => state.auth.account;
export const selectAuthLoading = (state: AuthRootState) => state.auth.loading;
export const selectAuthInitializing = (state: AuthRootState) => state.auth.initializing;
